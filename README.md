...
> |----------|----------------|-----------------|
> | Docker / Podman Compose | [**Woow_podman_n8n**](https://github.com/WOOWTECH/Woow_podman_n8n) | `podman` |
> | K3s / Kubernetes (now a **Helm chart**) | [**Woow_k3s_n8n**](https://github.com/WOOWTECH/Woow_k3s_n8n) | `k3s` |
> | Home Assistant add-on | [**Woow_ha_n8n**](https://github.com/WOOWTECH/Woow_ha_n8n) | `ha` |
>
